...
describe "search_phrases/_edit.html.erb" do
  ...
  it "renders the template '_edit.html.erb_spec' with errors" do
    
    puts "*--Old> #{@search_phrase.to_yaml}"
    puts "*--New> #{@search_phrase_new.to_yaml}"
    render
    expect(view).to render_template("search_phrases/_error", "search_phrases/_edit")
  end
    
    
  it "renders the partial form '_edit.html.erb_spec'" do
    render
    puts "*--> #{rendered}"
